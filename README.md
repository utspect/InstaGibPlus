...
**ServerPackages=InstaGibPlus7B**  
**ServerActors=InstaGibPlus7B.NewNetServer**  
**ServerActors=InstaGibPlus7B.PureStats**  

<b>It is highly recommended to set your server's tickrate to 100.</b>

# Usage
For InstaGib, make sure the mutator **InstaGibPlus7B.NewNetIG** is loaded via your map vote configuration or during server launch.
...
2. Use `git clone https://github.com/utspect/InstaGibPlus InstaGibPlus7B` to clone the repo
3. Navigate to the newly created directory `InstaGibPlus7B`
4. Execute `build.bat`
