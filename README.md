...
# Usage
For InstaGib, make sure the mutator **InstaGibPlus8B.NewNetIG** is loaded via your map vote configuration or during server launch.
...
2. Use `git clone https://github.com/utspect/InstaGibPlus InstaGibPlus8B` to clone the repo
3. Navigate to the newly created directory `InstaGibPlus8B`
4. Execute `build.bat`
