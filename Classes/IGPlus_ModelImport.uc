...
#exec MESH IMPORT MESH=FCommandoM ANIVFILE=MODELS\FCommando_a.3D DATAFILE=MODELS\FCommando_d.3D UNMIRROR=1 LODSTYLE=12
#exec MESH ORIGIN MESH=FCommandoM X=23 Y=-115 Z=62 YAW=64 ROLL=-64

#exec MESH SEQUENCE MESH=FCommandoM SEQ=All       STARTFRAME=0   NUMFRAMES=681
#exec MESH SEQUENCE MESH=FCommandoM SEQ=GutHit    STARTFRAME=0   NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=AimDnLg   STARTFRAME=1   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=AimDnSm   STARTFRAME=2   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=AimUpLg   STARTFRAME=3   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=AimUpSm   STARTFRAME=4   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Taunt1    STARTFRAME=5   NUMFRAMES=15 RATE=20	Group=Gesture
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Breath1   STARTFRAME=20  NUMFRAMES=7  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Breath2   STARTFRAME=27  NUMFRAMES=20 RATE=7	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=CockGun   STARTFRAME=47  NUMFRAMES=6  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DuckWlkL  STARTFRAME=53  NUMFRAMES=15 RATE=15	Group=Ducking
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DuckWlkS  STARTFRAME=68  NUMFRAMES=15 RATE=15	Group=Ducking
#exec MESH SEQUENCE MESH=FCommandoM SEQ=HeadHit   STARTFRAME=83  NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=JumpLgFr  STARTFRAME=84  NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=JumpSmFr  STARTFRAME=85  NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=LandLgFr  STARTFRAME=86  NUMFRAMES=1			Group=Landing
#exec MESH SEQUENCE MESH=FCommandoM SEQ=LandSmFr  STARTFRAME=87  NUMFRAMES=1			Group=Landing
#exec MESH SEQUENCE MESH=FCommandoM SEQ=LeftHit   STARTFRAME=88  NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Look      STARTFRAME=89  NUMFRAMES=35 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=RightHit  STARTFRAME=124 NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=RunLg     STARTFRAME=125 NUMFRAMES=10 RATE=17
#exec MESH SEQUENCE MESH=FCommandoM SEQ=RunLgFr   STARTFRAME=135 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=RunSm     STARTFRAME=145 NUMFRAMES=10 RATE=17
#exec MESH SEQUENCE MESH=FCommandoM SEQ=RunSmFr   STARTFRAME=155 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=StillFrRp STARTFRAME=165 NUMFRAMES=10 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=StillLgFr STARTFRAME=175 NUMFRAMES=10 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=StillSmFr STARTFRAME=185 NUMFRAMES=8  RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=SwimLg    STARTFRAME=193 NUMFRAMES=18 RATE=15
#exec MESH SEQUENCE MESH=FCommandoM SEQ=SwimSm    STARTFRAME=211 NUMFRAMES=18 RATE=15
#exec MESH SEQUENCE MESH=FCommandoM SEQ=TreadLg   STARTFRAME=229 NUMFRAMES=15 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=TreadSm   STARTFRAME=244 NUMFRAMES=15 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Victory1  STARTFRAME=259 NUMFRAMES=10 RATE=6  	Group=Gesture
#exec MESH SEQUENCE MESH=FCommandoM SEQ=WalkLg    STARTFRAME=269 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=FCommandoM SEQ=WalkLgFr  STARTFRAME=284 NUMFRAMES=15 RATE=18	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=WalkSm    STARTFRAME=299 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=FCommandoM SEQ=WalkSmFr  STARTFRAME=314 NUMFRAMES=15 RATE=18	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Wave      STARTFRAME=329 NUMFRAMES=15 RATE=15	Group=Gesture
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Walk      STARTFRAME=344 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=FCommandoM SEQ=TurnLg    STARTFRAME=284 NUMFRAMES=2  RATE=15					// 2 frames of walklgfr
#exec MESH SEQUENCE MESH=FCommandoM SEQ=TurnSm    STARTFRAME=314 NUMFRAMES=2  RATE=15					// 2 frames of walksmfr
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Breath1L  STARTFRAME=359 NUMFRAMES=7  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Breath2L  STARTFRAME=366 NUMFRAMES=20 RATE=7	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=CockGunL  STARTFRAME=386 NUMFRAMES=6  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=LookL     STARTFRAME=392 NUMFRAMES=35 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=WaveL     STARTFRAME=427 NUMFRAMES=15 RATE=15	Group=Gesture
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Chat1     STARTFRAME=442 NUMFRAMES=13 RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Chat2     STARTFRAME=455 NUMFRAMES=10 RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Thrust    STARTFRAME=465 NUMFRAMES=15 RATE=20	Group=Gesture
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DodgeB    STARTFRAME=480 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DodgeF    STARTFRAME=481 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DodgeR    STARTFRAME=482 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DodgeL    STARTFRAME=483 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Fighter   STARTFRAME=175 NUMFRAMES=1								// first frame of stilllgfr
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Flip      STARTFRAME=484 NUMFRAMES=22 RATE=33	Group=Jumping
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead2     STARTFRAME=515 NUMFRAMES=18 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead3     STARTFRAME=533 NUMFRAMES=16 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead4     STARTFRAME=549 NUMFRAMES=13 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead6     STARTFRAME=562 NUMFRAMES=11 RATE=10

#exec MESH SEQUENCE MESH=FCommandoM SEQ=DeathEnd  STARTFRAME=532 NUMFRAMES=1
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DeathEnd2 STARTFRAME=561 NUMFRAMES=1
#exec MESH SEQUENCE MESH=FCommandoM SEQ=DeathEnd3 STARTFRAME=572 NUMFRAMES=1

#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead1     STARTFRAME=573 NUMFRAMES=23 RATE=12
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead5     STARTFRAME=596 NUMFRAMES=13 RATE=12
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead9     STARTFRAME=609 NUMFRAMES=20 RATE=12
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead9B    STARTFRAME=629 NUMFRAMES=11 RATE=12
#exec MESH SEQUENCE MESH=FCommandoM SEQ=Dead7     STARTFRAME=640 NUMFRAMES=11 RATE=12
#exec MESH SEQUENCE MESH=FCommandoM SEQ=BackRun   STARTFRAME=651 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=StrafeL   STARTFRAME=661 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=FCommandoM SEQ=StrafeR   STARTFRAME=671 NUMFRAMES=10 RATE=17	Group=MovingFire

#exec MESHMAP SCALE MESHMAP=FCommandoM X=0.0625 Y=0.0625 Z=0.125

#exec MESH NOTIFY MESH=FCommandoM SEQ=RunLG   TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunLG   TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunLGFR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunLGFR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunSM   TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunSM   TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunSMFR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=RunSMFR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=StrafeL TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=StrafeL TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=StrafeR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=StrafeR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=BackRun TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=BackRun TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead2   TIME=0.66 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead3   TIME=0.38 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead4   TIME=0.46 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead6   TIME=0.54 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead1   TIME=0.69 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead5   TIME=0.61 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead9b  TIME=0.45 FUNCTION=LandThump
#exec MESH NOTIFY MESH=FCommandoM SEQ=Dead7   TIME=0.54 FUNCTION=LandThump

//
// SGirl
//

#exec MESH IMPORT MESH=SGirlM ANIVFILE=Models\SGirl_a.3D DATAFILE=Models\SGirl_d.3D UNMIRROR=1 LODSTYLE=12
#exec MESH ORIGIN MESH=SGirlM X=23 Y=-115 Z=62 YAW=64 ROLL=-64

#exec MESH SEQUENCE MESH=SGirlM SEQ=All       STARTFRAME=0   NUMFRAMES=681
#exec MESH SEQUENCE MESH=SGirlM SEQ=GutHit    STARTFRAME=0   NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=AimDnLg   STARTFRAME=1   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=AimDnSm   STARTFRAME=2   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=AimUpLg   STARTFRAME=3   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=AimUpSm   STARTFRAME=4   NUMFRAMES=1			Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Taunt1    STARTFRAME=5   NUMFRAMES=15 RATE=20	Group=Gesture
#exec MESH SEQUENCE MESH=SGirlM SEQ=Breath1   STARTFRAME=20  NUMFRAMES=7  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Breath2   STARTFRAME=27  NUMFRAMES=20 RATE=7	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=CockGun   STARTFRAME=47  NUMFRAMES=6  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=DuckWlkL  STARTFRAME=53  NUMFRAMES=15 RATE=15	Group=Ducking
#exec MESH SEQUENCE MESH=SGirlM SEQ=DuckWlkS  STARTFRAME=68  NUMFRAMES=15 RATE=15	Group=Ducking
#exec MESH SEQUENCE MESH=SGirlM SEQ=HeadHit   STARTFRAME=83  NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=JumpLgFr  STARTFRAME=84  NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=JumpSmFr  STARTFRAME=85  NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=LandLgFr  STARTFRAME=86  NUMFRAMES=1			Group=Landing
#exec MESH SEQUENCE MESH=SGirlM SEQ=LandSmFr  STARTFRAME=87  NUMFRAMES=1			Group=Landing
#exec MESH SEQUENCE MESH=SGirlM SEQ=LeftHit   STARTFRAME=88  NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=Look      STARTFRAME=89  NUMFRAMES=35 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=RightHit  STARTFRAME=124 NUMFRAMES=1			Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=RunLg     STARTFRAME=125 NUMFRAMES=10 RATE=17
#exec MESH SEQUENCE MESH=SGirlM SEQ=RunLgFr   STARTFRAME=135 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=RunSm     STARTFRAME=145 NUMFRAMES=10 RATE=17
#exec MESH SEQUENCE MESH=SGirlM SEQ=RunSmFr   STARTFRAME=155 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=StillFrRp STARTFRAME=165 NUMFRAMES=10 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=StillLgFr STARTFRAME=175 NUMFRAMES=10 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=StillSmFr STARTFRAME=185 NUMFRAMES=8  RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=SwimLg    STARTFRAME=193 NUMFRAMES=18 RATE=15
#exec MESH SEQUENCE MESH=SGirlM SEQ=SwimSm    STARTFRAME=211 NUMFRAMES=18 RATE=15
#exec MESH SEQUENCE MESH=SGirlM SEQ=TreadLg   STARTFRAME=229 NUMFRAMES=15 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=TreadSm   STARTFRAME=244 NUMFRAMES=15 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Victory1  STARTFRAME=259 NUMFRAMES=10 RATE=6  	Group=Gesture
#exec MESH SEQUENCE MESH=SGirlM SEQ=WalkLg    STARTFRAME=269 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=SGirlM SEQ=WalkLgFr  STARTFRAME=284 NUMFRAMES=15 RATE=18	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=WalkSm    STARTFRAME=299 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=SGirlM SEQ=WalkSmFr  STARTFRAME=314 NUMFRAMES=15 RATE=18	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=Wave      STARTFRAME=329 NUMFRAMES=15 RATE=15	Group=Gesture
#exec MESH SEQUENCE MESH=SGirlM SEQ=Walk      STARTFRAME=344 NUMFRAMES=15 RATE=18
#exec MESH SEQUENCE MESH=SGirlM SEQ=TurnLg    STARTFRAME=284 NUMFRAMES=2  RATE=15					// 2 frames of walklgfr
#exec MESH SEQUENCE MESH=SGirlM SEQ=TurnSm    STARTFRAME=314 NUMFRAMES=2  RATE=15					// 2 frames of walksmfr
#exec MESH SEQUENCE MESH=SGirlM SEQ=Breath1L  STARTFRAME=359 NUMFRAMES=7  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Breath2L  STARTFRAME=366 NUMFRAMES=20 RATE=7	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=CockGunL  STARTFRAME=386 NUMFRAMES=6  RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=LookL     STARTFRAME=392 NUMFRAMES=35 RATE=15	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=WaveL     STARTFRAME=427 NUMFRAMES=15 RATE=15	Group=Gesture
#exec MESH SEQUENCE MESH=SGirlM SEQ=Chat1     STARTFRAME=442 NUMFRAMES=13 RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Chat2     STARTFRAME=455 NUMFRAMES=10 RATE=6	Group=Waiting
#exec MESH SEQUENCE MESH=SGirlM SEQ=Thrust    STARTFRAME=465 NUMFRAMES=15 RATE=20	Group=Gesture
#exec MESH SEQUENCE MESH=SGirlM SEQ=DodgeB    STARTFRAME=480 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=DodgeF    STARTFRAME=481 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=DodgeR    STARTFRAME=482 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=DodgeL    STARTFRAME=483 NUMFRAMES=1			Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=Fighter   STARTFRAME=175 NUMFRAMES=1								// first frame of stilllgfr
#exec MESH SEQUENCE MESH=SGirlM SEQ=Flip      STARTFRAME=484 NUMFRAMES=22 RATE=33	Group=Jumping
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead2     STARTFRAME=515 NUMFRAMES=18 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead3     STARTFRAME=533 NUMFRAMES=16 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead4     STARTFRAME=549 NUMFRAMES=13 RATE=10	Group=TakeHit
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead6     STARTFRAME=562 NUMFRAMES=11 RATE=10

#exec MESH SEQUENCE MESH=SGirlM SEQ=DeathEnd  STARTFRAME=532 NUMFRAMES=1
#exec MESH SEQUENCE MESH=SGirlM SEQ=DeathEnd2 STARTFRAME=561 NUMFRAMES=1
#exec MESH SEQUENCE MESH=SGirlM SEQ=DeathEnd3 STARTFRAME=572 NUMFRAMES=1

#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead1     STARTFRAME=573 NUMFRAMES=23 RATE=12
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead5     STARTFRAME=596 NUMFRAMES=13 RATE=12
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead9     STARTFRAME=609 NUMFRAMES=20 RATE=12
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead9B    STARTFRAME=629 NUMFRAMES=11 RATE=12
#exec MESH SEQUENCE MESH=SGirlM SEQ=Dead7     STARTFRAME=640 NUMFRAMES=11 RATE=12
#exec MESH SEQUENCE MESH=SGirlM SEQ=BackRun   STARTFRAME=651 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=StrafeL   STARTFRAME=661 NUMFRAMES=10 RATE=17	Group=MovingFire
#exec MESH SEQUENCE MESH=SGirlM SEQ=StrafeR   STARTFRAME=671 NUMFRAMES=10 RATE=17	Group=MovingFire

#exec MESHMAP SCALE MESHMAP=SGirlM X=0.0625 Y=0.0625 Z=0.125

#exec MESH NOTIFY MESH=SGirlM SEQ=RunLG   TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunLG   TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunLGFR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunLGFR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunSM   TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunSM   TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunSMFR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=RunSMFR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=StrafeL TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=StrafeL TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=StrafeR TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=StrafeR TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=BackRun TIME=0.25 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=BackRun TIME=0.75 FUNCTION=PlayFootStep
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead2   TIME=0.66 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead3   TIME=0.38 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead4   TIME=0.46 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead6   TIME=0.54 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead1   TIME=0.69 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead5   TIME=0.61 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead9b  TIME=0.45 FUNCTION=LandThump
#exec MESH NOTIFY MESH=SGirlM SEQ=Dead7   TIME=0.54 FUNCTION=LandThump
...
DefaultProperties
{
	DefaultMesh(0)=LodMesh'FCommando'
	DefaultMesh(1)=LodMesh'FCommando'
	DefaultMesh(2)=LodMesh'FCommando'
	DefaultMesh(3)=LodMesh'FCommando'
	DefaultMesh(4)=LodMesh'SGirl'
	DefaultMesh(5)=LodMesh'SGirl'
	DefaultMesh(6)=LodMesh'SGirl'
	DefaultMesh(7)=LodMesh'SGirl'
	DefaultMesh(8)=LodMesh'SGirl'
	...
	RateCorrectedMesh(0)=LodMesh'FCommandoM'
	RateCorrectedMesh(1)=LodMesh'FCommandoM'
	RateCorrectedMesh(2)=LodMesh'FCommandoM'
	RateCorrectedMesh(3)=LodMesh'FCommandoM'
	RateCorrectedMesh(4)=LodMesh'SGirlM'
	RateCorrectedMesh(5)=LodMesh'SGirlM'
	RateCorrectedMesh(6)=LodMesh'SGirlM'
	RateCorrectedMesh(7)=LodMesh'SGirlM'
	RateCorrectedMesh(8)=LodMesh'SGirlM'
